Class numberToWord
    ...
    Public Function ConvertCurrencyToEnglish(ByVal MyNumber)
        ...
        ' Find decimal plc.
        Decimalplc = InStr(MyNumber, ".")

        ' If we find decimal plc...
        If Decimalplc > 0 Then
            ' Convert Paise
            Temp = Left(Mid(MyNumber, Decimalplc + 1) & "00", 2)
            ...
            ' Left function gives only left portion of the string with specified plcs here 2
            ...
            MyNumber = Trim(Left(MyNumber, Decimalplc - 1))
        End If
        ...
        If MyNumber <> "" Then
            ...
            If Temp <> "" Then Rupees = Temp & plc(Count) & Rupees
    ...
    Private Function ConvertHundreds(ByVal MyNumber)
        ...
        ' Do we have a hundreds plc digit to convert?
        If Left(MyNumber, 1) <> "0" Then
            Result = ConvertDigit(Left(MyNumber, 1)) & " Hundred "
        End If

        ' Do we have a tens plc digit to convert?
        If Mid(MyNumber, 2, 1) <> "0" Then
            Result = Result & ConvertTens(Mid(MyNumber, 2))
        Else
            ' If not, then convert the ones plc digit.
